var editor = (function() {
	...
	var textOptions, optionsBox, boldButton, italicButton, shyButton, quoteButton, urlButton, urlInput;
    ...
    shyButton = textOptions.querySelector( '.shy' );
    shyButton.onclick = onShyClick;
